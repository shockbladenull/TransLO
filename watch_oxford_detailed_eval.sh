...
DEFAULT_OXFORD_POSE_TXT_TEMPLATE='Oxford_SLAM_result_{sequence_short}/gicp_Oxford{sequence_short}_050_v1.txt'
OXFORD_POSE_TXT_TEMPLATE="${OXFORD_POSE_TXT_TEMPLATE:-$DEFAULT_OXFORD_POSE_TXT_TEMPLATE}"
