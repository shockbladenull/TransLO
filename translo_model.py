...
class translo_model(nn.Module):
    def __init__(self, args, batch_size, H_input, W_input, is_training, bn_decay=None):
        ...
        self.out_W_list = [math.ceil(self.W_input / self.stride_W_list[0])] #self.W_input
    ...
    def forward(self, input_xyz_f1, input_xyz_f2, T_gt, T_trans, T_trans_inv):
        ...
        # Flame 1
        l0_points_f1, l0_points_proj_f1 = self.layer0(input_xyz_aug_proj_f1, input_points_f1, l0_xyz_proj_f1)  ###l0层的F1
        ...
        l2_points_cross_proj_f1 = torch.reshape(l2_points_cross_f1, (batch_size, self.out_H_list[2], self.out_W_list[2], -1))
        l2_points_cross_proj_f2 = torch.reshape(l2_points_cross_f2, (batch_size, self.out_H_list[2], self.out_W_list[2], -1))
        l2_cost_volume_origin = self.cost_volume1(l2_xyz_proj_f1, l2_xyz_proj_f2, l2_points_cross_proj_f1, l2_points_cross_proj_f2)
        l2_cost_volume_origin_proj = torch.reshape(l2_cost_volume_origin, [batch_size, self.out_H_list[2], self.out_W_list[2], -1])  ##E2
        ...
        l3_cost_volume, l3_cost_volume_proj = self.laye3_1(l2_xyz_proj_f1, l2_cost_volume_origin_proj, l3_xyz_proj_f1)  ##E3

        ###l3 cost_volume
        l3_cost_volume_w = self.flow_predictor0(l3_points_f1, None, l3_cost_volume)  ##E3和F3_f1融合
        ...
        # print(l2_points_warp_proj_f1.shape)
        ...
        l2_cost_volume = self.cost_volume2(l2_xyz_warp_proj_f1, l2_xyz_proj_f2, l2_points_warp_cross_proj_f1, l2_points_warp_cross_proj_f2)  ##RE

        l2_cost_volume_w_upsample = self.set_upconv1_w_upsample(l2_xyz_warp_proj_f1, l3_xyz_proj_f1, l2_points_warp_proj_f1, l3_cost_volume_w_proj)  ###CE
        ...
        l2_cost_volume_predict = self.flow_predictor1_predict(l2_points_warp_f1, l2_cost_volume_upsample, l2_cost_volume)  ##E
        ...
        l2_cost_volume_sum = softmax_valid(feature_bnc=l2_cost_volume_predict, weight_bnc=l2_cost_volume_w, mask_valid=l2_mask_warped)  # embedding mask  B 1 C
        ...
        l1_cost_volume = self.cost_volume3(l1_xyz_warp_proj_f1, l1_xyz_proj_f2, l1_points_warp_cross_proj_f1, l1_points_warp_cross_proj_f2)
        ...
        l0_cost_volume = self.cost_volume4(l0_xyz_warp_proj_f1, l0_xyz_proj_f2, l0_points_warp_cross_proj_f1, l0_points_warp_cross_proj_f2)
