...
def PreProcess(PC_f1, PC_f2, T_gt, T_trans, T_trans_inv, aug_frame):    ####    pre process procedure
    ...
    for i in range(batch_size):
        ...
        cur_PC_f1_aft_aug = cur_PC_f1_aft_aug * mask_valid_f1 # N 3
        cur_PC_f2_aft_aug = cur_PC_f2_aft_aug * mask_valid_f2
        ...
        if i ==0:
            ...
            # q_gt.append(cur_q_gt)
            # t_gt.append(cur_t_gt)
            q_gt = torch.cat([q_gt, cur_q_gt], 0)  ##array
            t_gt = torch.cat([t_gt, cur_t_gt], 0)

        PC_f1_aft_aug.append(cur_PC_f1_aft_aug)### list
        PC_f2_aft_aug.append(cur_PC_f2_aft_aug)
